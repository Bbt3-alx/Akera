export function serializeCorrespondentCollection(collection) {
  ...
  return {
    ...
    inputAmount: collection.inputAmount,
    inputCurrency: collection.inputCurrency,
    inputSide: collection.inputSide,
    conversionDirection: collection.conversionDirection,
